...
local on_attach = function(_, bufnr) -- function(client, bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, 'n', '<F9>', '<cmd>lua vim.lsp.buf.code_action()<CR>', opts)
...
local servers = { 'rust_analyzer', 'solargraph', 'typeprof', 'tailwindcss', 'sumneko_lua', 'sorbet' }
